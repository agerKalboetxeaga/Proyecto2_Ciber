...
public class OMTG_DATAST_001_SharedPreferences extends AppCompatActivity {
    ...
    public void gakoakSortu() {
        try {
            ...
            masterKey = new MasterKey.Builder(OMTG_DATAST_001_SharedPreferences.this)
    ...
    public void enkriptatu() {
        try {
            SharedPreferences sharedPreferences = EncryptedSharedPreferences.create(OMTG_DATAST_001_SharedPreferences.this, "key",
                    masterKey,
